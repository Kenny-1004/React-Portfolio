...
export default function AboutMe({aboutRef}) {
    ...
    return (
        <section ref={aboutRef} className="w-full py-30 max-h-max flex flex-col items-center justify-center ">
            <h1 className="text-center font-bold text-4xl bar opacity-0">About Me</h1>
            <p className="bar opacity-0 w-7/8 mx-auto mt-8 text-gray-600">
            ...
            <p className="bar opacity-0 w-7/8 mx-auto mt-7 text-gray-600">
            ...
            <div className="bar opacity-0 flex items-center w-7/8 mx-auto gap-5 mt-5">
                <Github />
                <Facebook />
                <Mail />
            </div>
            <div className="w-7/8 bar opacity-0 mx-auto mt-5 grid grid-rows-2 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-2 gap-4">
