    ...
    return (
        <footer ref={contactsRef} className="w-full max-h-max py-40 bg-gray-100">
            <div className="w-7/8 mx-auto">
                <h1 className="bar opacity-0 text-center text-4xl poppins-semibold ">
                    Lets Work Together!
                </h1>
                <p className="bar opacity-0 w-7/8 text-center mx-auto text-gray-500 my-10">
                ...
                <div className="font-semibold flex mt-5 items-center justify-center gap-5 max-h-max w-full mx-auto button-container">
                    <button className="bg-black text-white bar opacity-0 flex justify-center hover:scale-105 buttons py-2 px-5 rounded-md hover:bg-blue-600 transition-all duration-300">
                        <div className="flex items-center gap-3">
                            <img className="size-6" src={gmail} alt="" />
                            Email me
                        </div>
                    </button>
                    <button className="bar opacity-0 gap-3 flex justify-center hover:scale-105 border border-gray-400 py-2 px-5 rounded-md buttons hover:text-white hover:bg-blue-600 transition-all duration-300 ">
                        <div className="flex items-center gap-3">
                ...
                <div className="w-full text-center mt-10 bar opacity-0">
